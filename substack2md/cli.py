...
from ._core import (
    ...
    __version__, build_url_to_note_map, cleanup_url, collapse_blank_lines_in_lists,
    ensure_dir, get_publication_name, load_config, log, normalize_tags,
    remove_blank_after_headings, rewrite_internal_links,
    sanitize_filename, scrub_transcript_lines, slugify, with_frontmatter,
)
  ...
  SUBSTACK2MD_CONFIG      Path to config.yaml file
    ...
    def worker(url: str) -> None:
        ...
        with host_lock(host):
            ...
            out = pkg.process_url(url, base_dir, pub_mappings, args.also_save_html,
